    ...
    <q-layout view="lHh Lpr fff" v-show="loaded">
        ...
        <q-layout-drawer v-model="drawerState" behavior="mobile">
            <q-list no-border link inset-delimiter>
                ...
                <q-collapsible icon="people_outline" label="Team" :opened="['team', 'collaborations'].includes(page)">
                ...
                <q-collapsible icon="build" label="Project" :opened="['description', 'design', 'experiments', 'notebook', 'interlab', 'model', 'results', 'demonstrate', 'improve', 'attributions',].includes(page)">
                    <route-item page="description" link="http://2018.igem.org/Team:Thessaloniki/Description" icon="info"
                        label="Description">
                    </route-item>
                    <route-item page="design" link="http://2018.igem.org/Team:Thessaloniki/Design" icon="create" label="Design">
                    </route-item>
                    <route-item page="experiments" link="http://2018.igem.org/Team:Thessaloniki/Experiments" icon="colorize"
                        label="Experiments">
                    </route-item>
                    ...
                    <route-item page="demonstrate" link="http://2018.igem.org/Team:Thessaloniki/Collaborations" icon="looks"
                        label="Demonstrate">
                    </route-item>
                    <route-item page="improve" link="http://2018.igem.org/Team:Thessaloniki/Improve" icon="plus_one" label="Improve">
                    </route-item>
                    <route-item page="attributions" link="http://2018.igem.org/Team:Thessaloniki/Attributions" icon="people"
                        label="Attributions">
                    </route-item>
                </q-collapsible>
